...
_ENV_MAPPINGS = {
    ...
    "channel_enabled": "EVOSCIENTIST_CHANNEL_ENABLED",
    "channel_send_thinking": "EVOSCIENTIST_CHANNEL_SEND_THINKING",
    "require_mention": "EVOSCIENTIST_REQUIRE_MENTION",
    "text_chunk_limit": "EVOSCIENTIST_TEXT_CHUNK_LIMIT",
    "allowed_channels": "EVOSCIENTIST_ALLOWED_CHANNELS",
    "feishu_app_id": "EVOSCIENTIST_FEISHU_APP_ID",
    "feishu_app_secret": "EVOSCIENTIST_FEISHU_APP_SECRET",
    "feishu_verification_token": "EVOSCIENTIST_FEISHU_VERIFICATION_TOKEN",
    "feishu_encrypt_key": "EVOSCIENTIST_FEISHU_ENCRYPT_KEY",
    "feishu_webhook_port": "EVOSCIENTIST_FEISHU_WEBHOOK_PORT",
    "feishu_allowed_senders": "EVOSCIENTIST_FEISHU_ALLOWED_SENDERS",
    "feishu_domain": "EVOSCIENTIST_FEISHU_DOMAIN",
    "feishu_proxy": "EVOSCIENTIST_FEISHU_PROXY",
    "ccproxy_port": "EVOSCIENTIST_CCPROXY_PORT",
    "shared_webhook_port": "EVOSCIENTIST_SHARED_WEBHOOK_PORT",
    "wechat_backend": "EVOSCIENTIST_WECHAT_BACKEND",
    "wechat_webhook_port": "EVOSCIENTIST_WECHAT_WEBHOOK_PORT",
    "wechat_allowed_senders": "EVOSCIENTIST_WECHAT_ALLOWED_SENDERS",
    "wechat_proxy": "EVOSCIENTIST_WECHAT_PROXY",
    "wechat_wecom_corp_id": "EVOSCIENTIST_WECHAT_WECOM_CORP_ID",
    "wechat_wecom_agent_id": "EVOSCIENTIST_WECHAT_WECOM_AGENT_ID",
    "wechat_wecom_secret": "EVOSCIENTIST_WECHAT_WECOM_SECRET",
    "wechat_wecom_token": "EVOSCIENTIST_WECHAT_WECOM_TOKEN",
    "wechat_wecom_encoding_aes_key": "EVOSCIENTIST_WECHAT_WECOM_ENCODING_AES_KEY",
    "wechat_mp_app_id": "EVOSCIENTIST_WECHAT_MP_APP_ID",
    "wechat_mp_app_secret": "EVOSCIENTIST_WECHAT_MP_APP_SECRET",
    "wechat_mp_token": "EVOSCIENTIST_WECHAT_MP_TOKEN",
    "wechat_mp_encoding_aes_key": "EVOSCIENTIST_WECHAT_MP_ENCODING_AES_KEY",
}
